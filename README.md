## gazebo3_ros_pkgs (hydro) - 2.4.2-5

The packages in the `gazebo3_ros_pkgs` repository were released into the `hydro` distro by running `/usr/bin/bloom-release --track hydro-current --ros-distro hydro gazebo3_ros_pkgs --edit` on `Mon, 04 Aug 2014 23:05:29 -0000`
...
Version of package(s) in repository `gazebo3_ros_pkgs`:
...
## gazebo3_ros_pkgs (hydro) - 2.4.2-4

The packages in the `gazebo3_ros_pkgs` repository were released into the `hydro` distro by running `/usr/bin/bloom-release --track hydro-current --ros-distro hydro gazebo3_ros_pkgs --edit` on `Mon, 04 Aug 2014 15:23:04 -0000`
...
## gazebo3_ros_pkgs (hydro) - 2.4.2-3

User `jrivero@quartz` released the packages in the `gazebo3_ros_pkgs` repository into the `hydro` distro by running `/usr/bin/bloom-release --track hydro-current --ros-distro hydro gazebo3_ros_pkgs --edit` on `Sun, 13 Apr 2014 16:36:56 -0000`
...
## gazebo3_ros_pkgs (groovy) - 2.4.2-3

User `jrivero@quartz` released the packages in the `gazebo3_ros_pkgs` repository into the `groovy` distro by running `/usr/bin/bloom-release --track groovy --ros-distro groovy gazebo3_ros_pkgs --edit` on `Sun, 13 Apr 2014 16:24:38 -0000`
...
## gazebo3_ros_pkgs (groovy) - 2.4.2-2

User `jrivero@quartz` released the packages in the `gazebo3_ros_pkgs` repository into the `groovy` distro by running `/usr/bin/bloom-release --track groovy --ros-distro groovy gazebo3_ros_pkgs --edit` on `Thu, 10 Apr 2014 00:11:49 -0000`
...
## gazebo3_ros_pkgs (groovy) - 2.4.2-1

User `jrivero@quartz` released the packages in the `gazebo3_ros_pkgs` repository into the `groovy` distro by running `/usr/bin/bloom-release --track groovy --ros-distro groovy gazebo3_ros_pkgs --edit` on `Wed, 09 Apr 2014 23:59:26 -0000`
...
## gazebo3_ros_pkgs (hydro) - 2.4.2-2

User `jrivero@quartz` released the packages in the `gazebo3_ros_pkgs` repository into the `hydro` distro by running `/usr/bin/bloom-release --track hydro-current --ros-distro hydro gazebo3_ros_pkgs --edit` on `Wed, 09 Apr 2014 23:39:03 -0000`
...
## gazebo3_ros_pkgs (hydro) - 2.4.2-1

User `jrivero@quartz` released the packages in the `gazebo3_ros_pkgs` repository into the `hydro` distro by running `/usr/bin/bloom-release --track hydro-current --ros-distro hydro gazebo3_ros_pkgs --edit` on `Wed, 09 Apr 2014 22:19:57 -0000`
